...
const SPREADS = [
  ...
  },
  {
    ...
    layout: 'cross',
    positions: [
      { name: '核心', meaning: '问题的核心和本质' },
      { name: '阻碍', meaning: '当前的障碍和挑战' },
      { name: '根源', meaning: '问题的深层根源' },
      { name: '建议', meaning: '应对的建议和方法' },
      { name: '结果', meaning: '可能的结果和走向' },
    ],
  },
  {
    id: 'celtic-cross',
    ...
    layout: 'celtic',
    positions: [
      { name: '现状', meaning: '当前所处的核心状况' },
      { name: '阻碍', meaning: '横在面前的障碍或助力' },
      { name: '根源', meaning: '问题的基础和根源' },
      { name: '过去', meaning: '最近的过去和正在消退的影响' },
      { name: '目标', meaning: '可能达成的目标或方向' },
      { name: '近未来', meaning: '即将发生的近期事件' },
      { name: '自我', meaning: '你在这个问题中的态度和位置' },
      { name: '环境', meaning: '周围环境和他人的影响' },
      { name: '希望', meaning: '内心的希望和恐惧' },
      { name: '结果', meaning: '最终可能的结果' },
    ],
  },
  {
    id: 'relationship',
